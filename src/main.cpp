...
const string strMessageMagic = "BOSScoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BOSScoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BOSScoin 1billion";
        CTransaction txNew;
        txNew.nTime = 1401552000;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1401552000;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 5609890;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xaca51d0cf3cf9d9b61bcfb7c09b5bed5326e06aafc2956e361445dc06fecdd68"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf1, 0xf2, 0xf3, 0xf4 };
